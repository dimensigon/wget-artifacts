...
su - tibero -c "wget -q https://raw.githubusercontent.com/dimensigon/wget-artifacts/master/lightweight/start_12g.bash -O /home/tibero/start_12g.bash"

su - tibero -c "chmod +x start_12g.bash && bash start_12g.bash"
